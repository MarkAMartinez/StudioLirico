            ...
            <div>
                ...
                <div className="prose prose-invert max-w-none mb-8 space-y-6">
                    <p className="text-lg leading-relaxed">
                        Studio Lirico NYC will produce a Masterclass Series for six participants with internationally renowned soprano 
                        <strong> Elizabeth Blancke-Biggs</strong> (<a href="http://www.elizabethblancke-biggs.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">www.elizabethblancke-biggs.com</a>) 
                        and <strong>Mo. Michael Recchiuti</strong> (<a href="http://www.michaelrecchiuti.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">www.michaelrecchiuti.com</a>).
                    </p>
                    ...
                    <p className="text-lg leading-relaxed">
                         Within two days of the recording singers will receive high definition video recordings of their performances usable for all applications and competitions.
                    </p>
                    ...
                    <div className="bg-secondary/30 p-8 border border-white/10 my-8">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-white/80">Saturday, March 15</p>
                    ...
                    <div className="bg-card p-8 border border-white/10 mb-8">
                        ...
                        <p className="mb-4">
                            Please send bio, headshot and two video or audio links to:
                            <br/>
