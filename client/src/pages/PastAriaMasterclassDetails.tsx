...
export default function PastAriaMasterclassDetails() {
          ...
          <div>
            ...
            <div className="prose prose-invert max-w-none mb-8 space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                ...
                recording audition arias, leading toward a professionally recorded high definition recital performance
                session.
              </p>

              <p className="text-lg leading-relaxed">
                Within two days of the recording singers received high definition video recordings of their
                performances usable for applications and competitions.
              </p>
              ...
              <div className="bg-card p-8 border border-white/10 mb-8">
                ...
                <p className="text-sm text-white/60">Participants were notified by February 21.</p>
              </div>
            </div>
          </div>
        </div>
