              ...
              <Card className="bg-card border-none rounded-none overflow-hidden group hover:shadow-2xl transition-all duration-500">
                <div className="aspect-[3/4] bg-neutral-900 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-8 w-full z-10">
                    ...
                    <p className="text-white/80 text-sm mb-6">Audition Package Masterclass Series</p>
                    <Button 
                      variant="outline" 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-card border border-white/10 rounded-none overflow-hidden group hover:shadow-2xl transition-all duration-500">
              <div className="aspect-video bg-neutral-900 relative overflow-hidden">
                <img
                    src={ariaSeries}
                    alt="Aria Masterclass Series — June 2026"
                    className="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700"
                />
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-heading font-bold text-white mb-2">Aria Masterclass Series &mdash; June 2026</h3>
                <p className="text-muted-foreground text-sm mb-4">
                  Elizabeth Blancke-Biggs &amp; Mo. Michael Recchiuti.
                </p>
                <Button
                  variant="link"
                  className="text-white hover:text-primary p-0 h-auto font-medium"
                  onClick={() => setLocation("/past-events/aria-masterclass-series-june")}
                >
